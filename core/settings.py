...
SECRET_KEY = 'django-insecure-s=q(*k=y9*(_0yyctyb5=dax3h50mmwg74453!ei%$i(km!y&l'
...
JWT_AUTH = {
    ...
    "JWT_RESPONSE_PAYLOAD_HANDLER": "userauth.api.v1.utils.jwt_response_payload_handler_utils.jwt_response_payload_handler",
